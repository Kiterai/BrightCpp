...
struct audio_play_info {
    ...
    using streaming_callback = void(void *, audio_play_info *);
};
...
class audio_mixer {
  ...
  public:
    ...
    void set_playing(audio_context_id id, const audio_play_info &, audio_play_update_mask mask);
    audio_play_info get_playing(audio_context_id id) const;
