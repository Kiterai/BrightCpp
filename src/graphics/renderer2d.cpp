...
renderer2d &renderer2d::draw(const image &image, int x, int y) {
    return draw(image, x, y, 0.0f, 1.0f, 1.0f, pivot_pos::left_top);
}
renderer2d &renderer2d::draw(const image_clip &clip, int x, int y) {
    return draw(clip, x, y, 0.0f, 1.0f, 1.0f, pivot_pos::left_top);
}
renderer2d &renderer2d::draw(const image &image, int x, int y, float rotation) {
    return draw(image, x, y, rotation, 1.0f, 1.0f, pivot_pos::left_top);
}
renderer2d &renderer2d::draw(const image_clip &clip, int x, int y, float rotation) {
    return draw(clip, x, y, rotation, 1.0f, 1.0f, pivot_pos::left_top);
}
renderer2d &renderer2d::draw(const image &image, int x, int y, float scale_x, float scale_y) {
    return draw(image, x, y, 0.0f, scale_x, scale_y, pivot_pos::left_top);
}
renderer2d &renderer2d::draw(const image_clip &clip, int x, int y, float scale_x, float scale_y) {
    return draw(clip, x, y, 0.0f, scale_x, scale_y, pivot_pos::left_top);
}
renderer2d &renderer2d::draw(const image &image, int x, int y, float rotation, float scale_x, float scale_y) {
    return draw(image, x, y, rotation, scale_x, scale_y, pivot_pos::left_top);
}
renderer2d &renderer2d::draw(const image_clip &clip, int x, int y, float rotation, float scale_x, float scale_y) {
    return draw(clip, x, y, rotation, scale_x, scale_y, pivot_pos::left_top);
}

renderer2d &renderer2d::draw(const image &image, int x, int y, pivot image_pivot) {
    return draw(image, x, y, 0.0f, 1.0f, 1.0f, image_pivot);
}
renderer2d &renderer2d::draw(const image_clip &clip, int x, int y, pivot clip_pivot) {
    return draw(clip, x, y, 0.0f, 1.0f, 1.0f, clip_pivot);
}
renderer2d &renderer2d::draw(const image &image, int x, int y, float rotation, pivot image_pivot) {
    return draw(image, x, y, rotation, 1.0f, 1.0f, image_pivot);
}
renderer2d &renderer2d::draw(const image_clip &clip, int x, int y, float rotation, pivot clip_pivot) {
    return draw(clip, x, y, rotation, 1.0f, 1.0f, clip_pivot);
}
renderer2d &renderer2d::draw(const image &image, int x, int y, float scale_x, float scale_y, pivot image_pivot) {
    return draw(image, x, y, 0.0f, scale_x, scale_y, image_pivot);
}
renderer2d &renderer2d::draw(const image_clip &clip, int x, int y, float scale_x, float scale_y, pivot clip_pivot) {
