...
class renderer2d_vulkan : public renderer2d_backend {
    std::reference_wrapper<window_rendertarget_vulkan> rt;
  ...
  public:
    renderer2d_vulkan(vk::Device device, window_rendertarget_vulkan &rt, const queue_index_set &queue_indices);
